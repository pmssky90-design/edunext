...
def snapshot_before() -> None:
    ...
    target = REVIEW / "middle-school-english-before" / REPRESENTATIVE_PARENT / "index.html"
...
def main() -> int:
    ...
    print(f"generated middle-school English pages: {len(target_pages)}")
    ...
    print(f"representative: {OUTPUT / '부산하단중영어과외' / 'index.html'}")
    return 0 if len(target_pages) == 218 and len(parent_slugs) == 61 and len(pages) == 1898 else 1
